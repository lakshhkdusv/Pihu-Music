...
from NETFLIXMUSIC import app, Userbot
from typing import List, Union
from pyrogram import filters
from NETFLIXMUSIC.core.call import SHUKLA
...
async def strcall(client, message):
    ...
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./NETFLIXMUSIC/assets/call.mp3"), stream_type=StreamType().pulse_stream)
